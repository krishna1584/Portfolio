...
import "../assets/img/FINAL RESUME.pdf";
          ...
          <Col xs={12} md={6} xl={7}>
            <TrackVisibility>
              ...
              <div className={isVisible ? "animate__animated animate__fadeIn" : ""}>
                ...
                <h1>{`I'm Krishna Yadav`}</h1> <h1> <span className="txt-rotate" dataPeriod="2300" data-rotate='[ "Programmer","Content Creator" ]'><span className="wrap">{text}</span></span></h1>
                  ...
                  <button onClick={() => console.log('connect')}><a href = "../assets/img/Resume-Carol Dsilva.pdf" download>Download Resume</a> <a href = "../assets/img/FINAL RESUME.pdf" download><ArrowRightCircle size={25} /></a> </button>
              </div>}
            </TrackVisibility>
          </Col>
          <Col xs={12} md={6} xl={5}>
